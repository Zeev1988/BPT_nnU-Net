...
from BPT import HD_BET
from BPT.HD_BET.data_loading import load_and_preprocess, save_segmentation_nifti
from BPT.HD_BET.predict_case import predict_case_3D_net
from BPT.HD_BET.config import HD_BET_Config
from BPT.HD_BET.utils import postprocess_prediction, SetNetworkToVal, get_params_fname, maybe_download_parameters
...
def run_hd_bet(mri_fnames, output_fnames, mode="accurate", device=0, postprocess=False, do_tta=True, keep_mask=False,
               overwrite=True):
    """
    ...
    for in_fname, out_fname in zip(mri_fnames, output_fnames):
        mask_fname = out_fname.replace(".nii", "_mask.nii")
