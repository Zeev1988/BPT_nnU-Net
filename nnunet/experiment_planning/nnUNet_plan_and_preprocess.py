...
def preprocess(task_ids, planner_name3d="ExperimentPlanner3D_v21",
               planner_name2d="ExperimentPlanner2D_v21", tf=8, tl=8,
               dont_run_preprocessing=False, do_verify_dataset_integrity=False):
    ...
    for i in task_ids:
        ...
        if do_verify_dataset_integrity:
...
def main():
    ...
    preprocess(task_ids, planner_name3d, planner_name2d, tf, tl, dont_run_preprocessing,
